    ...
    <div className="pt-24 min-h-screen">
      <SectionWrapper>
        <FadeIn>
          <div className="mb-16 max-w-3xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold text-white tracking-tighter mb-6">
              Nossa História: Mavericks Collision
            </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 mt-16">
          ...
          <FadeIn delay={0.3}>
            <div className="p-8 rounded-3xl border border-white/10 bg-white/5 backdrop-blur-xl h-full flex flex-col justify-center">
              <h2 className="text-3xl font-bold text-white mb-6">O Manifesto Mavericks</h2>
              <p className="text-zinc-400 leading-relaxed font-light">
                Na Mavericks Collision, nós não fazemos reparos comuns — nós realizamos restaurações cirúrgicas de alto padrão. Mantemos o compromisso inegociável de empregar apenas materiais, tintas (como AkzoNobel Sikkens) e o maquinário mais moderno do mercado automotivo mundial. A nossa grande promessa e missão diária é entregar o seu veículo reestruturado, protegido e com um acabamento ainda mais brilhante e imponente do que quando saiu da própria concessionária.
              </p>
            </div>
          </FadeIn>
        </div>
